...
public class Act10 {
	...
	public static void main(String[] args) {
		...
		try (BufferedReader reader = new BufferedReader(new FileReader("codec.txt"))){
			...
			try (BufferedReader reader2 = new BufferedReader(new FileReader("cartaEncript.txt"));
				     BufferedWriter writer = new BufferedWriter(new FileWriter("cartaDesEncript.txt"))){
